...
addNewRow =()=> {
    ...
    row.innerHTML = `<td><input type="text" placeholder="Product name" class="product" id="product" required></td>
                    <td><input type="number" placeholder="0" name="unit" class="unit" id="unit" onkeyup="getInput()" required></td>
                    <td><input type="number" placeholder="0" name="price" class="price" id="price" onkeyup="getInput()" required></td>
                    <td><input type="number" placeholder="0" name="amount" class="amount" required id="amount" disabled></td>
